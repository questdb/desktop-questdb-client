...
public class EditorHighlighter extends DocumentFilter {
    ...
    protected static final AttributeSet HIGHLIGHT_COMMENT = styleForegroundColor(
        GTk.Editor.LINENO_COLOR.getRed(),
        GTk.Editor.LINENO_COLOR.getGreen(),
        GTk.Editor.LINENO_COLOR.getBlue());
    protected static final AttributeSet HIGHLIGHT_FUNCTION = styleForegroundColor(
        GTk.Editor.FUNCTION_FOREGROUND_COLOR.darker().getRed(),
        GTk.Editor.FUNCTION_FOREGROUND_COLOR.darker().getGreen(),
        GTk.Editor.FUNCTION_FOREGROUND_COLOR.darker().getBlue());
    protected static final AttributeSet HIGHLIGHT_KEYWORD = styleForegroundColor(
        GTk.Editor.KEYWORD_FOREGROUND_COLOR.getRed(),
        GTk.Editor.KEYWORD_FOREGROUND_COLOR.getGreen(),
        GTk.Editor.KEYWORD_FOREGROUND_COLOR.getBlue());
    protected static final AttributeSet HIGHLIGHT_TYPE = styleForegroundColor(
        GTk.Editor.TYPE_FOREGROUND_COLOR.getRed(),
        GTk.Editor.TYPE_FOREGROUND_COLOR.getGreen(),
        GTk.Editor.TYPE_FOREGROUND_COLOR.getBlue());
    protected static final AttributeSet HIGHLIGHT_NORMAL = styleForegroundColor(
        GTk.Editor.NORMAL_FOREGROUND_COLOR.getRed(),
        GTk.Editor.NORMAL_FOREGROUND_COLOR.getGreen(),
        GTk.Editor.NORMAL_FOREGROUND_COLOR.getBlue());
    private static final AttributeSet HIGHLIGHT_FIND_MATCH = styleForegroundColor(
        GTk.Editor.MATCH_FOREGROUND_COLOR.getRed(),
        GTk.Editor.MATCH_FOREGROUND_COLOR.getGreen(),
        GTk.Editor.MATCH_FOREGROUND_COLOR.getBlue());
    private static final AttributeSet HIGHLIGHT_ERROR = styleForegroundColor(
        GTk.Editor.ERROR_FOREGROUND_COLOR.getRed(),
